package com.hr.microservices.Holiday.HolidayMs.model;
...
public class HolidayRequest {
    ...
    public HolidayRequest(Long id, LocalDateTime requestDate, LocalDate holidayStart, LocalDate holidayEnd, ApprovalStatus approvalStatus) {
        this.id = id;
